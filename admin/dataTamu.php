...
<?php
$query = mysqli_query($koneksi, "SELECT * FROM tbl_kehadiran");
                ...
                <tbody>
                    ...
                    do { ?>
                        <tr>
                            ...
                            <td><?php echo $row_query['nomor']; ?></td>
                            <td><?php echo $row_query['konfirmasi_kehadiran']; ?></td>
                            <td><?php echo $row_query['sesi']; ?></td>
                            <td>
                                <a href="delete.php?delete=<?php echo $row_query['id_kehadiran'] ?>" onclick="return confirm('Yakin ingin menghapus data ?')" class="btn btn-danger" title="Hapus Data"><i class="fa fa-trash"></i></a>
                            </td>
                        </tr>
